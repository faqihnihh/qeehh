...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_query($conn, $query)) {
        ...
        // Cek apakah npm sudah terdaftar di tabel users
$checkUser = mysqli_query($conn, "SELECT * FROM users WHERE npm = '$npm'");
if (mysqli_num_rows($checkUser) == 0) {
    // Insert ke tabel users (akun login) dengan password default = npm
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="photo-upload">
                        ...
                        <div class="upload-controls">
                            ...
                            <small style="display: block; margin-top: 5px; color: var(--gray-color);">Format: JPG, PNG, GIF (Maks. 2MB)</small>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="program_studi" name="program_studi" required>
                            ...
                            <option value="PI">Pendidikan Informatika</option>
                        </select>
                    </div>
